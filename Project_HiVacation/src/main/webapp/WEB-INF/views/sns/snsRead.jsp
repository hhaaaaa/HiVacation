...
<body>
	...
	<table id="snsReadTable">
		<c:if test="${sessionScope.loginMember.hm_id == selectSNS.hs_id }">
			<tr>
			<td align="right" colspan="3" style="padding-right: 20px; height: 25px;">
		...
		<tr>
			<td align="center" style="width: 100%; border-bottom: black solid 2px; padding-bottom: 20px;" colspan="3">
				<c:forEach items="${snsReplys }" var="sr">
					<table class="replyTable">
						<tr>
							...
							<td class="replyUpdateButton">
								<a>수정</a>
							</td>
							<td align="center" class="replyDeleteButton" class="snsReadReply">
								<a class="snsReplyDeleteButton" rel="${sr.hr_no }">삭제</a>
							</td>
						</tr>
					</table>
				</c:forEach>
